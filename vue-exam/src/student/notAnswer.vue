<template>
  ...
  <el-main>
    ...
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column label="开始时间" prop="starttime" format="YYYY-MM-DD">
      </el-table-column>
      <el-table-column label="结束时间" prop="endtime" format="YYYY-MM-DD">
      </el-table-column>
      ...
      <el-table-column align="right">
        ...
        <template #default="scope">
          <el-button
            ...
            type="danger"
            v-if="
              Date.now() > notAnswerList.starttime && Date.now() < notAnswerList.endtime
            "
...
export default {
  ...
  methods: {
    handleDelete(index, row) {
      ...
      axios
        .post("http://localhost:8080/exam/student/findAllTi", qs.stringify(s), {
          Headers: {
  ...
  mounted() {
    ...
    console.log(this);
    axios
      .post("http://localhost:8080/exam/no/findAll", qs.stringify(stno), {
        Headers: {
          "Context-Type": "application/x-www-form-urlencoded",
        },
      })
