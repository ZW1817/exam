...
const routes = [{
...

    {
        ...
        children: [
            ...
            { path: "updatePass", components: { default: import('../admin/updatePassword.vue'), top: Head1, left: Aside1 } },
    ...
    // =======student======
    {
        ...
        children: [
            ...
            {path:"shijuan",components:{default:import('../student/shijuan.vue'),top: Head2, left: Aside2 }}
        ]
    },
    ...
    // =======teacher======
    {
        ...
        children: [
            ...
            { path: "yuejuan", components: { default: import ('../teacher/yuejuan.vue'), top: Head3, left: Aside3 } }
        ]
