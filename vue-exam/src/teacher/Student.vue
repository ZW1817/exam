...
export default {
  ...
  methods: {
    findAll(){
      axios.post('http://localhost:8080/exam/student/findALL')
            .then((req)=>{
...
<template>
  <el-main>
    <el-row>
      <el-col :span="24"><div class="grid-content ep-bg-purple-dark" > <label >班级:</label>
        ...
        <el-button type="primary" >查询</el-button></div></el-col>
    </el-row> 
    <el-row>
      <el-col :span="24">
