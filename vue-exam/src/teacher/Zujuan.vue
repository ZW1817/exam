    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          axios
            .post(
              "http://localhost:8080/exam/paperstate/zujuan",
              JSON.stringify(ShijuanLists),
              {
                headers: { "Content-Type": "application/json" },
              }
