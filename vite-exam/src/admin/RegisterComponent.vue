    ...
    <div class="login">
      <el-form :model="loginForm" status-icon :rules="rules" ref="loginForm" label-width="130px" class="demo-loginForm">
        ...
        <el-form-item label="用户名" prop="userId">
          <el-input type="text" v-model="loginForm.userId" autocomplete="off" placeholder="长度在5~12个字符之间" input-style="width:240px"></el-input>
        </el-form-item>
        <el-form-item label="密 码" prop="passWord">
          <el-input type="password" v-model="loginForm.passWord" autocomplete="off" placeholder="长度在5~12个字符之间" input-style="width:240px"></el-input>
        </el-form-item>
